                ...
                <el-form :model="form" label-width="120px">
                    ...
                    <el-form-item label="消息参数" required>
                        <p v-for="param in form.data_param">
                            {{param.name}}：<el-input v-model="param.value" placeholder="请输入" style="width: 400px"></el-input>
                        </p>
                    </el-form-item>
            ...
            new Vue({
                ...
                methods: {
                    doEdit: function () {
                        var that = this;
                        $.ajax({
                            url: "/Wechat/MiniSubscribeMessage/doTestSend",
                            type: "post",
                            data: this.form,
                            dataType: "json",
                    ...
                    getDetail: function (id) {
                        var that = this;
                        $.ajax({
                            url: "/Wechat/MiniSubscribeMessage/getDetail?id="+id,
                            type: "get",
                            dataType: "json",
                            success: function(res){
                                console.log(res)
