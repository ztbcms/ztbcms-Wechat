            ...
            new Vue({
                ...
                methods: {
                    submitTestTemplateEvent() {
                        ...
                        const _this = this;
                        this.httpPost("{:U('Wechat/Mini/sendTemplateMsg')}", postData, function (res) {
                            if (res.status) {
                    ...
                    syncEvent() {
                        var _this = this;
                        this.httpGet("{:U('Wechat/Mini/syncTemplateList')}", {}, function (res) {
                            if (res.status) {
                    ...
                    getTemplateList: function () {
                        ...
                        $.ajax({
                            url: "{:U('Wechat/Mini/templateList')}",
                            dataType: 'json',
                            type: 'get',
                            data: where,
